...
//rev::CANSparkMax m_rightFollowMotor{rightFollowDeviceID, rev::CANSparkMax::MotorType::kBrushed};
 ...
 private:
  ...
  //const std::string kAutoNameCustom3 = "My prius";
  //const std::string kAutoNameCustom4 = "My CRV";
  //const std::string kAutoNameCustom5 = "My kayak";
  //const std::string kAutoNameCustom6 = "My dog";
  ...
  //static constexpr int kJoystickChannel = 1;
